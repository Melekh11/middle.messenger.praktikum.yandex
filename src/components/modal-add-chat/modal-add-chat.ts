    ...
    constructor(props?: TProps) {
        super("div", {
            ...
            btnCreateChat: new Button({
                className: "base-btn", btnText: "сохранить!",
                events: {
                    click: async () => {
                        ...
                        const loginToInvite = (document.querySelector("#login-to-invite") as HTMLInputElement).value;
                        const avaChat = (document.querySelector("#ava-chat") as HTMLInputElement);

                        if (titleChat !== "" && loginToInvite !== "" && avaChat.files?.length !== 0) {
                            await userController.getByLogin(loginToInvite)
                                .then(async (resp) => {
                                    ...
                                    if (user) {
                                        ...
                                        document.querySelector("#ava-chat")
